...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="img/book.svg">
    <style>
      .modal-header {background: #004C6D;color:#fff;font-weight:800;}
      .modal-body{font-weight:800;}
      .modal-body ul{list-style:none;}
      .modal .btn {background: #004C6D;color:#fff;}
      .modal a{color: #004C6D;}
      .modal-backdrop {position:inherit !important;}
       #login_button,#register_button{background:none;color: #004C6D;;}       
       #query_button {position:fixed;right:0px;bottom:0px;padding:10px 80px;
                      background-color: #004C6D;color:#fff;border-color:#f05f40;border-radius:2px;}
      ...
      <div class="container-fluid">
          <div class="row">
              ...
              <div class="col-sm-4 col-md-3 col-lg-3 text-center">
                  <h2 style="color: #004C6D;">Follow Us At</h2>
                  <div>
